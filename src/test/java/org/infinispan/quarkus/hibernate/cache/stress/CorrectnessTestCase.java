package org.infinispan.quarkus.hibernate.cache.stress;
...
import org.infinispan.quarkus.hibernate.cache.stress.entities.Person;
...
public abstract class CorrectnessTestCase {
    private static final Logger log = Logger.getLogger(CorrectnessTestCase.class);
    ...
    public static class Jta extends CorrectnessTestCase {
        ...
        public List<Object[]> getParameters() {
            return Arrays.<Object[]>asList(
                    new Object[]{"transactional", AccessType.TRANSACTIONAL},
                    new Object[]{"read-only", AccessType.READ_ONLY}, // maybe not needed
                    new Object[]{"read-write", AccessType.READ_WRITE},
                    new Object[]{"non-strict", AccessType.NONSTRICT_READ_WRITE}
            );
        }
    ...
    protected void applySettings(StandardServiceRegistryBuilder ssrb) {
        ssrb.applySetting(Environment.CACHE_REGION_FACTORY, QuarkusInfinispanRegionFactory.class.getName());
